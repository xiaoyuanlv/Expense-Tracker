...
final class TransactionListViewModel: ObservableObject {
    ...
    func getTransactions() {
        guard let url = URL(string: "https://raw.githubusercontent.com/xiaoyuanlv/Expense-Tracker/main/transactions.json") else {
            print("Invalid URL")
            return
        }
        ...
        URLSession.shared.dataTaskPublisher(for: url)
            ...
            .sink { completion in
                switch completion {
                    case .failure(let error): print("Error fetching transaction", error.localizedDescription)
